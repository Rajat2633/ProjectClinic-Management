                        ...
                        do
                        {
...

                            {
                                ...
                                case 2:
                                    ...
                                    Console.WriteLine("Choose Patients Sex as Press1 :Male Press 2: Female Press 3: Others  ");
                                    string sex;
                                    ...
                                    {
                                        Console.WriteLine("Thank You ! Patient Details Succefully Recorded and saved");
                                ...
                                case 3:
                                    ...
                                    if(check_pd_id.Read())
                                    {
                                        ...
                                        if((to_check_slot_availabel-apttime)==0 || (to_check_slot_availabel-apttime)>=1)
                                        {
                                            ...
                                            string doctorlname = buslogic.extract_doc_lname(dcid);
                            ...
                            Console.WriteLine("Do You want to continue to Your Account Press y otherwise to Logout press n y/n");
